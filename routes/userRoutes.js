 ...
 */
router.get("/oneNote/:id", checkAuthAndRole("USER"), userCtrl.oneNote);
 ...
 */
router.put("/doneTask/:id", checkAuthAndRole("USER"), userCtrl.doneTask);
/***
 * @swagger
 * /user/allTasks:
 *   post:
 ...
 *                example: "مشکلی سمت سرور وجود دارد"
 */
router.get("/oneTask/:id", checkAuthAndRole("USER"), userCtrl.oneTask);
